  ...
  describe('Org only', () => {
    describe('Config', () => {
      it('Handles folder config (/)', () => {
        ...
        expect(details.origin).to.equal('https://admin.ssa-da.live');
        expect(details.fullpath).to.equal('/adobe/');
        expect(details.repo).to.equal(undefined);
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/config/adobe');
      ...
      it('Handles JSON config (.json)', () => {
        ...
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/config/adobe.json');
      ...
      it('Handles HTML config ()', () => {
        ...
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/config/adobe.html');
      });
    });
    ...
    describe('Sheet', () => {
      it('Handles JSON sheet ()', () => {
        ...
        const details = getPathDetails(loc);
        expect(details.fullpath).to.equal('/adobe.json');
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/source/adobe.json');
      });
    });
    ...
    describe('Edit ()', () => {
      it('Handles HTML edit details ()', () => {
        ...
        const details = getPathDetails(loc);
        expect(details.fullpath).to.equal('/adobe.html');
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/source/adobe.html');
      });
    });
  ...
  describe('Org and repo', () => {
    describe('Config', () => {
      it('Handles folder config (/)', () => {
        ...
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/config/adobe/geometrixx');
      ...
      it('Handles JSON config (.json)', () => {
        ...
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/config/adobe/geometrixx.json');
        expect(details.parent).to.equal('/adobe');
        expect(details.parentName).to.equal('adobe');
      });
      ...
      it('Handles HTML config ()', () => {
        ...
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/config/adobe/geometrixx.html');
      });
    });
    ...
    describe('Sheet', () => {
      it('Handles JSON sheet ()', () => {
        ...
        const details = getPathDetails(loc);
        expect(details.fullpath).to.equal('/adobe/geometrixx.json');
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/source/adobe/geometrixx.json');
      });
    });
    ...
    describe('Edit ()', () => {
      it('Handles HTML edit ()', () => {
        ...
        const details = getPathDetails(loc);
        expect(details.fullpath).to.equal('/adobe/geometrixx.html');
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/source/adobe/geometrixx.html');
      });
    });
  });
  ...
  describe('Org, repo, and path', () => {
    describe('Config', () => {
      it('Handles folder config (/)', () => {
        ...
        expect(details.repo).to.equal('geometrixx');
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/config/adobe/geometrixx/testing-123');
        expect(details.name).to.equal('config');
      ...
      it('Handles JSON config (.json)', () => {
        ...
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/config/adobe/geometrixx/testing-123.json');
        expect(details.parent).to.equal('/adobe/geometrixx');
        expect(details.parentName).to.equal('geometrixx');
      });
      ...
      it('Handles HTML config ()', () => {
        ...
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/config/adobe/geometrixx/testing-123.html');
      });
    });
    ...
    describe('Sheet', () => {
      it('Handles JSON sheet ()', () => {
        ...
        const details = getPathDetails(loc);
        expect(details.fullpath).to.equal('/adobe/geometrixx/testing-123.json');
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/source/adobe/geometrixx/testing-123.json');
      });
    });
    ...
    describe('Edit ()', () => {
      it('Handles HTML edit ()', () => {
        ...
        const details = getPathDetails(loc);
        expect(details.fullpath).to.equal('/adobe/geometrixx/testing-123.html');
        expect(details.sourceUrl).to.equal('https://admin.ssa-da.live/source/adobe/geometrixx/testing-123.html');
      });
    });
  });
